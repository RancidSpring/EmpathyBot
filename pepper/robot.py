    ...
    **Real robot controller**
    ...
    def start_animation(self, animation):
        ...
        try:
            ...
            # animation_finished = self.animation_service.run("animations/[posture]/Gestures/" + animation, _async=True)
            animation_finished = self.animation_service.run(animation, _async=True)
    ...
    def take_picture(self):
        ...
        photoName = "../photos/" + str(random.randint(0, 1000)) + ".png"
    ...
    def pick_a_volunteer(self):
        ...
        self.unsubscribe_effector()
        self.stand()
        self.say("Looking for a face to detect")
    ...
    def look_for_a_person_and_take_picture(self, say_something, phrase=None):
        """
        Complex movement for choosing a random people.
        ...
        >>> pepper.look_for_a_person_and_take_picture()
        ...
        while not volunteer_found:
            wait = numpy.random.randint(500, 1500) / 1000
            theta = numpy.random.randint(-20, 20)
            self.turn_around(theta)
            # time.sleep(wait)
            # self.stop_moving()
            # self.stand()
